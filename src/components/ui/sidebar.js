...
const SidebarTrigger = React.forwardRef(({ className, onClick, asChild = false, ...props }, ref) => {
    ...
    return ((_jsx(Button, { ref: ref, "data-sidebar": "trigger", variant: "ghost", size: "icon", className: cn("h-7 w-7", className), onClick: (event) => {
            onClick?.(event);
            toggleSidebar();
        }, asChild: asChild, ...props, children: asChild ? (_jsx(PanelLeft, {})) : (_jsxs(_Fragment, { children: [_jsx(PanelLeft, {}), _jsx("span", { className: "sr-only", children: "Toggle Sidebar" })] })) })));
});
