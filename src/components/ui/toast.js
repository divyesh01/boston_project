...
const ToastProvider = React.forwardRef(({ ...props }, ref) => (_jsx("div", { ref: ref, className: "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]", ...props })));
ToastProvider.displayName = "ToastProvider";
const ToastViewport = React.forwardRef(({ ...props }, ref) => (_jsx("div", { ref: ref, className: "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]", ...props })));
...
const Toast = React.forwardRef(({ className, variant, ...props }, ref) => {
    return (_jsx("div", { ref: ref, className: cn(toastVariants({ variant }), className), ...props }));
});
...
const ToastTitle = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("text-sm font-semibold", className), ...props })));
ToastTitle.displayName = "ToastTitle";
const ToastDescription = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("text-sm opacity-90", className), ...props })));
